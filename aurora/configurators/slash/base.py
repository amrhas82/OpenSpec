...
ALL_COMMANDS = ["plan", "archive", "implement", "query", "mem", "index", "search"]


class SlashCommandConfigurator(ABC):
    """Abstract base for tool-specific slash command configurators.

    Each AI coding tool (Claude Code, OpenCode, AmpCode) has its own
    ...
    def generate_all(self, project_path: str, aurora_dir: str) -> List[str]:
        ...
        Args:
            ...
            aurora_dir: Aurora directory path
