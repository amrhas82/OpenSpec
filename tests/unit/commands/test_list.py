...
class TestListCommand:
    ...
    def test_missing_openspec_changes_directory(self, list_command, temp_dir):
        """Should handle missing openspec/changes directory."""
        with pytest.raises(
            RuntimeError,
...
"""
    ...
    def test_list_specs_mode(self, list_command, temp_dir, capsys):
        ...
        specs_dir = temp_dir / "openspec" / "specs"
